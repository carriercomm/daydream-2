...
// Weíre not using anything product specific yet. We undef these so we donít get the usual
...
// Also weíre not using any serialization/versioning so we donít need any of these.
...
void Systems::PhysicsSystem::OnEntityRemoved( EntityID entity )
{
	...
	{
		LOG_INFO("Removed rigid body of entity %i abogfusdkifbhdzfsgiudfhghdfhgdhfˆgˆdhfgˆdhfˆdhfˆdfjhˆdgfdgfˆuhudgf", entity);
